...
public class JhipsterElasticSearchSampleApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterElasticSearchSampleApp.class);

    private final Environment env;

    public JhipsterElasticSearchSampleApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterElasticSearchSample.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterElasticSearchSampleApp.class);
